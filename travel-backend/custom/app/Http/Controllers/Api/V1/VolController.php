...
class VolController extends Controller
{
    ...
    public function update(Request $request, Vol $vol): JsonResponse
    {
        ...
        // ── Notification si le statut du vol a changé ──────────────────────
        // On notifie tous les passagers concernés uniquement en cas de
        // changement réel (évite les notifications parasites sur des mises à
        // jour de prix ou de places).
